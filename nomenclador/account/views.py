...
from nomenclador.account.utils import get_default_redirect
from nomenclador.account.models import OtherServiceInfo
from nomenclador.account.forms import SignupForm, AddEmailForm, LoginForm, \
    ChangePasswordForm, SetPasswordForm, ResetPasswordForm, \
    TwitterForm, ResetPasswordKeyForm
...
@login_required
def timezone_change(request,*args,**kwargs):
    pass
    

@login_required
def language_change(request, *args, **kwargs):
    pass
